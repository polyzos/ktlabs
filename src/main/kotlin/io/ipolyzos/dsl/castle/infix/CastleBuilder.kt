package io.ipolyzos.dsl.castle.infix

import io.ipolyzos.dsl.models.Connectable
import io.ipolyzos.dsl.models.DrawBridge
...
class CastleDsl {
    fun build() {
        ...
        castle {
            ...
            hall has HallBuilder.Feature.fireplace
            hall has HallBuilder.Feature.kitchen
...
class HallBuilder(val name: String = "", var features: Set<Feature> = mutableSetOf(), var capacity: Int = 0, var color: String = "white") : KeepBuildingBuilder {
    ...
    infix fun has(feature: Feature) {
        when (feature) {
            Feature.fireplace -> features += Feature.fireplace
            Feature.diningroom -> features += Feature.diningroom
            Feature.kitchen -> features += Feature.kitchen
        }
    }
